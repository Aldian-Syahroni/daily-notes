...
function Layout({ children, onCreateNote }) {
  const currentYear = (/* @__PURE__ */ new Date()).getFullYear();
  const hostname = typeof window !== "undefined" ? window.location.hostname : "";
  const caffeineUrl = `https://caffeine.ai?utm_source=caffeine-footer&utm_medium=referral&utm_content=${encodeURIComponent(hostname)}`;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-50 bg-card border-b border-border shadow-subtle", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2.5 group", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-md bg-primary flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { className: "w-4 h-4 text-primary-foreground" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-xl text-foreground tracking-tight group-hover:text-primary transition-colors duration-200", children: "Catatan Harian" })
      ] }),
      onCreateNote && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "Catatan Baru" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-muted/40 border-t border-border py-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-4xl mx-auto px-4 sm:px-6 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground", children: [
      "© ",
      currentYear,
      ".",
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "a",
        {
          ...
          children: "Dibuat dengan ❤ menggunakan caffeine.ai"
        }
      )
    ] }) }) })
  ] });
...
const NoteUpdate = Record({
  "id": NoteId,
  "title": Text,
  "content": Text
});
Service({
  "createNote": Func([NoteInput], [Note], []),
  "deleteNote": Func([NoteId], [Bool], []),
  "getNote": Func([NoteId], [Opt(Note)], ["query"]),
  "listNotes": Func([], [Vec(Note)], ["query"]),
  "searchNotes": Func([Text], [Vec(Note)], ["query"]),
  "updateNote": Func([NoteUpdate], [Opt(Note)], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  const NoteInput2 = IDL2.Record({ "title": IDL2.Text, "content": IDL2.Text });
  ...
  const NoteUpdate2 = IDL2.Record({
    "id": NoteId2,
    "title": IDL2.Text,
    "content": IDL2.Text
  });
  return IDL2.Service({
    "createNote": IDL2.Func([NoteInput2], [Note2], []),
    ...
    "searchNotes": IDL2.Func([IDL2.Text], [IDL2.Vec(Note2)], ["query"]),
    "updateNote": IDL2.Func([NoteUpdate2], [IDL2.Opt(Note2)], [])
  });
};
class Backend {
...
function useNote(id2) {
  const { actor, isFetching } = useBackend();
  return useQuery({
    queryKey: ["notes", id2 == null ? void 0 : id2.toString()],
    queryFn: async () => {
      if (!actor || id2 === void 0) return null;
      return actor.getNote(id2);
    },
...
function formatRelativeTime(timestamp) {
  ...
  if (isToday(date)) {
    return formatDistanceToNow(date, { addSuffix: true, locale: id$2 });
  }
  if (isYesterday(date)) {
    return `Kemarin ${format(date, "HH:mm")}`;
  }
  if (isThisWeek(date, { weekStartsOn: 1 })) {
    return format(date, "EEEE HH:mm", { locale: id$2 });
  }
  return format(date, "d MMM yyyy", { locale: id$2 });
}
function formatFullDate(timestamp) {
  const ms = typeof timestamp === "bigint" ? Number(timestamp) / 1e6 : timestamp;
  return format(new Date(ms), "d MMMM yyyy, HH:mm", { locale: id$2 });
}
