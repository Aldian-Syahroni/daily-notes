import { r as reactExports, j as jsxRuntimeExports, R as React, a as reactDomExports, v as vt, c as cn, o, u as useRouter, b as useParams, S as Skeleton } from "./index-DqP1-Ozk.js";
import { c as createLucideIcon, b as composeRefs, d as useComposedRefs, e as buttonVariants, h as useNote, i as useUpdateNote, j as useDeleteNote, L as Layout, B as Button, m as motion, f as formatRelativeTime, k as formatFullDate } from "./proxy-CE_EdgfE.js";
/**
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-10 w-3/4 mt-6" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-40 mt-2" }),
...
function NotFoundState({ onBack }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-2xl bg-destructive/10 flex items-center justify-center mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "w-8 h-8 text-destructive/60" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-xl text-foreground mb-2", children: "Catatan tidak ditemukan" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground text-center max-w-xs mb-6", children: "Catatan yang kamu cari mungkin sudah dihapus atau tidak tersedia." }),
...
function SaveIndicator({ status }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.span,
    {
      ...
      animate: { opacity: 1, y: 0 },
      exit: { opacity: 0 },
      className: `text-xs flex items-center gap-1 ${status === "saving" ? "text-muted-foreground" : status === "saved" ? "text-accent" : "text-destructive"}`,
      "data-ocid": `note_detail.${status === "saving" ? "loading" : status}_state`,
      children: [
        status === "saving" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block w-3 h-3 border-2 border-muted-foreground border-t-transparent rounded-full animate-spin" }),
...
function NoteDetailPage() {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      ue.success("Catatan berhasil dihapus");
      router.navigate({ to: "/" });
    } catch {
      ue.error("Gagal menghapus catatan");
    }
  };
  const handleBack = () => {
    router.navigate({ to: "/" });
  ...
  if (!note) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(NotFoundState, { onBack: handleBack }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-4 sm:px-6 py-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeft, { className: "w-4 h-4" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Semua Catatan" })
          ]
        }
      ),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "Hapus" })
              ]
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { "data-ocid": "note_detail.dialog", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { children: "Hapus catatan ini?" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogDescription, { children: "Tindakan ini tidak dapat dibatalkan. Catatan akan dihapus secara permanen." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogFooter, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogCancel, { "data-ocid": "note_detail.cancel_button", children: "Batal" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                AlertDialogAction,
                {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mb-6 pb-4 border-b border-border", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5 text-xs text-muted-foreground", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { title: formatFullDate(note.updatedAt), children: [
                "Diperbarui ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: content.trim() ? `${content.trim().split(/\s+/).length} kata · ${content.length} karakter` : "Mulai menulis…" }) })
  ] }) });
}
export {
